...
if __name__ == '__main__':
    ...
    add_argument(
        "--boost_keywords",
        type=str,
        help="Comma separated keywords to boost ranking",
        default=None,
    )
    add_argument(
        "--boost_weight",
        type=float,
        help="Weight for keyword boosting",
        default=5.0,
    )
    ...
    if len(papers) == 0:
        ...
        papers = rerank_paper(papers, corpus, boost_keywords=args.boost_keywords, boost_weight=args.boost_weight)
